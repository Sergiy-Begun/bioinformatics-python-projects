...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 13 21:14:28 2024
...
# generate all possible cyclic peptides of given length
# find the top candidate that fit the experimental mass spectrum

def top_candidate_peptide_of_given_length_based_on_spectrum_finder_function(max_length: int, experimental_mass_spectrum: list):
    """
    ...
    ----------
    max_length : int
        A maximum length of cyclic peptide.
    experimental_mass_spectrum : list
        An experimental mass spectrum to compare with.

    Returns
    -------
    A top candidate with best score.
